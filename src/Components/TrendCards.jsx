      ...
      const card2Content = (product) => (
        <>
            ...
            <div className="card_lower">
                ...
                <p className="price">{(product.price/1000)},000 Kr</p>
    ...
    return(
        <>
            ...
            <div className="Lower_trending_part">
                <div className="CIO-offers-you">
                    <h1 className="offers_you_header">Why CIO?</h1>
                </div>
                    ...
                    <div className="svg-container">
                        <div className="contain2">
                            ...
                            <div className="svg_words">
                                ...
                                <p className="svg_paragraph">CIO offers various of items to select, promotions, and personalized products.</p>
                            </div>
                        </div>
                        <div className="contain2">
                            ...
                            <div className="svg_words">
                                ...
                                <p className="svg_paragraph">Supported in more than 10 countries. Register to get 10,000 Kr coupons.</p>
                            </div>
                        </div>
                        <div className="contain2">
                        ...
                        <div className="contain2">
                            ...
                            <div className="svg_words">
                                ...
                                <p className="svg_paragraph">Buy high quality and popular products with CIO that you won't regret.</p>
                            </div>
                        </div>
                        <div className="contain2">
